    ...
    <group position={position} rotation={rotation}>
      ...
      <group position={[0, 4, 0]}>
        <mesh>
          ...
          <meshStandardMaterial color={state === 'red' ? "#ff0000" : "#330000"} emissive={state === 'red' ? "#ff0000" : "#000"} />
        </mesh>
      ...
      <group position={[0, 3.5, 0]}>
        <mesh>
          <sphereGeometry args={[0.15, 16, 16]} />
          <meshStandardMaterial color={state === 'yellow' ? "#ffff00" : "#333300"} emissive={state === 'yellow' ? "#ffff00" : "#000"} />
        </mesh>
      ...
      <group position={[0, 3, 0]}>
        <mesh>
          <sphereGeometry args={[0.15, 16, 16]} />
          <meshStandardMaterial color={state === 'green' ? "#00ff00" : "#003300"} emissive={state === 'green' ? "#00ff00" : "#000"} />
        </mesh>
